 ...
 * IDs are instance-scoped; data-logo-part supplies stable local animation targets.
 */
...
>(function FunkSpaceLogoInline(
  ...
  const instanceId = `fs-logo-${useId().replace(/:/g, "")}`;
  ...
  return (
    ...
    >
      <g id={`${instanceId}-logoMark`}>
        <g id={`${instanceId}-logoMarkPhats`}>
          <polygon
            id={`${instanceId}-logo-path-1`}
        ...
        <g id={`${instanceId}-logoMarkDots`}>
          <circle
            id={`${instanceId}-lmd-dot-9`}
            data-logo-part="lmd-dot-9"
            cx="1205.07"
            cy="75.52"
            r="12.45"
          ...
          />
          <circle
            id={`${instanceId}-lmd-dot-8`}
            data-logo-part="lmd-dot-8"
            cx="1486.18"
            cy="169.91"
            r="12.45"
            fill="var(--fs-color-content-primary)"
          />
          <circle
            id={`${instanceId}-lmd-dot-7`}
            data-logo-part="lmd-dot-7"
            cx="1603.97"
            cy="288.21"
            r="18.66"
            fill="var(--fs-color-content-primary)"
          />
          <circle
            id={`${instanceId}-lmd-dot-6`}
            data-logo-part="lmd-dot-6"
            cx="1627.21"
            cy="453.51"
            r="24.88"
            fill="var(--fs-color-content-primary)"
          />
          <circle
            id={`${instanceId}-lmd-dot-5`}
            data-logo-part="lmd-dot-5"
            cx="1102.42"
            cy="837.31"
            r="12.45"
            fill="var(--fs-color-content-primary)"
          />
          <circle
            id={`${instanceId}-lmd-dot-4`}
            data-logo-part="lmd-dot-4"
            cx="1445.52"
            cy="473.44"
            r="37.33"
            fill="var(--fs-color-content-primary)"
          />
          <circle
            id={`${instanceId}-lmd-dot-3`}
            data-logo-part="lmd-dot-3"
            cx="1440.63"
            cy="312.11"
            r="31.11"
            fill="var(--fs-color-content-primary)"
          />
          <circle
            id={`${instanceId}-lmd-dot-2`}
            data-logo-part="lmd-dot-2"
            cx="1157.55"
            cy="217.07"
            r="31.11"
            fill="var(--fs-color-content-primary)"
      ...
      <g id={`${instanceId}-logoText`}>
        <g id={`${instanceId}-lt-space`}>
          <g id={`${instanceId}-lts-s`}>
            <path
              id={`${instanceId}-logo-path-2`}
              data-logo-part="logo-path-2"
              data-name="lts-s"
          ...
          <g id={`${instanceId}-lts-p`}>
            <path
              id={`${instanceId}-logo-path-3`}
              data-logo-part="logo-path-3"
              data-name="lts-p"
          ...
          <g id={`${instanceId}-lts-a`}>
            <path
              id={`${instanceId}-logo-path-4`}
              data-logo-part="logo-path-4"
              data-name="lts-a"
          ...
          <g id={`${instanceId}-lts-c`}>
            <path
              id={`${instanceId}-logo-path-5`}
              data-logo-part="logo-path-5"
              data-name="lts-c"
          ...
          <g id={`${instanceId}-lts-e`}>
            <path
              id={`${instanceId}-logo-path-6`}
        ...
        <g id={`${instanceId}-lt-funk`}>
          <g id={`${instanceId}-ltf-f`}>
            <polygon
              id={`${instanceId}-logo-path-7`}
          ...
          <g id={`${instanceId}-ltf-u`}>
            <path
              id={`${instanceId}-logo-path-8`}
              data-logo-part="logo-path-8"
              data-name="ltf-u"
          ...
          <g id={`${instanceId}-ltf-n`}>
            <path
              id={`${instanceId}-logo-path-9`}
              data-logo-part="logo-path-9"
              data-name="ltf-n"
          ...
          <g id={`${instanceId}-ltf-k`}>
            <polygon
              id={`${instanceId}-logo-path-10`}
              data-logo-part="logo-path-10"
              data-name="ltf-k"
